            ...
            <div className="flex flex-col"> {/* right column */}
              ...
              <form action="" method="post">
                <div>
                  ...
                  <input className={styles.loginfields} type="text" name="netid" placeholder="NetID" />
                </div>
                <div>
                  <label className="sr-only" htmlFor="password">Password</label>
                  <input className={styles.loginfields} type="password" name="password" placeholder="Password" />
                </div>
